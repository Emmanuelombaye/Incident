...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5 bg-dark">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright @CeoAntidote2025 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://www.sourcecodester.com/" target="_blank"></a></div>ManDoctor</div>
        </footer>
